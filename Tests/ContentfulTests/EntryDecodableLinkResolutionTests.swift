...
class LinkClass: Resource, EntryDecodable, EntryQueryable {
...
class SingleRecord: Resource, EntryDecodable, EntryQueryable {
...
class LinkResolverTests: XCTestCase {
    ...
    func testDecoderCanResolveArrayOfLinks() {
        ...
        LinkResolverTests.client.fetch(ArrayResponse<SingleRecord>.self,  query) { result in
